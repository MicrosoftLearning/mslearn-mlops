...
# Create dev resource group and workspace
...
# Create shared compute resources in dev
...
# Create prod resource group and workspace
...
# Create registry resource group and shared registry
